...
#include "accelerators/null_accelerator.hh"

/* Parameter Create */
NullAccelerator*
NullAcceleratorParams::create()
{
    return new NullAccelerator(this);
}

/* Override the recieve function */
bool
NullAccelerator::recvAcceleratorReq(void* id,
